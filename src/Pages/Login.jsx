          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                required
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 text-center ring-1 ring-inset ring-gray-300 placeholder:text-blue-600 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
